...
bom_object = ElectricMachineBom(name="test bom",
                                electrical_steel=107,
                                other_steel=10,
                                aluminum=16,
                                copper=10,
                                ndfeb=2.5,
...
def get_pei_matrix(em_bom_object: ElectricMachineBom):
    em_bom = em_bom_object.get_bom_as_array()
